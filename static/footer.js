  ...
  connectedCallback() {
    this.innerHTML = `
        ...
        <div class="text-center">
          <div>
            <a class="flex-none text-xl font-semibold text-black dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#" aria-label="Brand">Prasad Junghare</a>
          </div>
          <!-- End Col -->
      
          <div class="mt-3">
            <p class="text-gray-500">We're part of the <a class="font-semibold text-blue-600 hover:text-blue-700 dark:text-blue-500 dark:hover:text-blue-400" href="loremcodes.html">loremocdes</a> family.</p>
            <p class="text-gray-500">© thejunghare. 2023 loremcodes. All rights reserved.</p>
          </div>
